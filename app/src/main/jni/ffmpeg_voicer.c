...
//音频播放
JNIEXPORT void JNICALL Java_com_example_ffmpeg_AudioActivity_audioPlayer
    ...
    jobject audio_track = (*env)->CallObjectMethod(env, audioutil_obj, create_audio_track_mid, out_sample_rate,
                                                   out_channel_nb);
