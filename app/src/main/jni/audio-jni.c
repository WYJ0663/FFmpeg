...
int createBufferQueueAudioPlayer() {
    ...
    // register callback init_filter_graphon the buffer queue
...
Java_com_example_ffmpeg_SLESAudioActivity_play(JNIEnv *env, jclass type, jstring url_) {

    const char *url = (*env)->GetStringUTFChars(env, url_, 0);

    pthread_t thread;
    pthread_create(&thread, NULL, open_media, url);
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_ffmpeg_SLESAudioActivity_destory(JNIEnv *env, jclass type) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_ffmpeg_SLESAudioActivity_stop(JNIEnv *env, jclass type) {
...
//JNIEXPORT void JNICALL
//Java_com_example_ffmpeg_SLESAudioActivity_player(JNIEnv *env, jclass type, jstring url_) {
//
//}
//
//JNIEXPORT void JNICALL
